		...
		for (let r = 1; r < 23; r++) {
			svgDoc.getElementById(`region_${r}`).addEventListener(
				"click", (event) => {
					...
					document.getElementById("data_out_Wealth").innerText = escapeHtml(data[region_id].Wealth.toFixed(2));
					document.getElementById("data_out_Taxation").innerText = escapeHtml(data[region_id].Taxation.toFixed(2));
					document.getElementById("data_out_Security").innerText = escapeHtml(data[region_id].Security.toFixed(2));
					document.getElementById("data_out_Unrest").innerText = escapeHtml(data[region_id].Unrest.toFixed(2));
					document.getElementById("data_out_Services_Provided").innerText = escapeHtml(data[region_id].Services_Provided.toFixed(2));
					document.getElementById("data_out_Services_Required").innerText = escapeHtml(data[region_id].Services_Required.toFixed(2));
